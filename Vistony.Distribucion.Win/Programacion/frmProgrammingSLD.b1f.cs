...
namespace Vistony.Distribucion.Win.Programacion
{
    ...
    class frmProgrammingSLD : UserFormBase
    {
        ...
        public void UpdateDespachoSLD(string dispatchDate, string driverCode, string driverName, string driverLicence, string assistantCode, string assistantName, string vehiculeCode, string vehiculeName, string vehiculeBrandName)
        {
                  ...
                  //  oForm.Freeze(true);
                    ...
                    for (int row = 0; row < Grid0.Rows.Count ; row++)
                    {
                        ...
                        if (Grid0.DataTable.GetString("Marca", row) == "Y")
                        {
                            ...
                            using (EntregaBLL entregaBLL = new EntregaBLL())
                            {
                                entregaBLL.UpdateEstadoSLD(docEntry, objDespachoJson, ref response);
                            }
                        }
                    }
